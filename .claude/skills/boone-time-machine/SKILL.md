...
- **Third Element "Boone-face" (id 321257875325567)** — an IMAGE subject built 2026-09-13 from real photos (cover: tight laughing face crop; secondary: full laughing portrait + full-body standing). This is the one to bind for STILLS: image_to_image with elements=[{"id":"321257875325567","bindName":"Boone"}] and <<<321257875325567>>> in the prompt. Source photos live in Drive → My Drive/Boone's Time Machine/face-reference (boone face smile.jpg, boone-body.jpg, boone look up wide angle.jpg — the last is 12.7 MB, over the connector's 10 MB download limit). Drive downloads arrive as base64 JSON saved to a tool-results file: decode with jq -r .content | base64 -d. Kling image inputs must be < 4K, so scale phone originals to 2160×2880 first.
